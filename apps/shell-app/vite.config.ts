...
export default defineConfig({
  ...
  plugins: [
    ...
    federation({
      name: 'shell-app',
      remotes: {
        headerMfe: 'http://localhost:3006/assets/remoteEntry.js',
        ...
        checkoutMfe: 'http://localhost:3007/assets/remoteEntry.js',
        paymentMfe: 'http://localhost:3008/assets/remoteEntry.js',
      },
